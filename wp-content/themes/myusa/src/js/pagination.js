...
let notesOnPage = 1; //количество записей на странице
...
let paginationSize = items.length; // pages size
let paginationPage = 1; // selected page
let paginationStep = 3; // pages before and after current

console.log(paginationSize);


//очистить контейнер с записями
...
//
//         var html = [
//             '<a class="pagination-btn-p"></a>', // previous button
//             '<span></span>',  // pagination container
//             '<a class="pagination-btn-n"></a>'  // next button
//         ];
//
